...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='scraper',
            options={'ordering': ['name', 'scraped_obj_class', '-valid_until']},
        ),
        migrations.AddField(
            model_name='scraper',
            name='dupefilter_exclude_urls',
        ...
        migrations.AddField(
            model_name='generalscraper',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dynamic_scraper.GeneralScraperCategory'),
        ),
        migrations.AddField(
            model_name='generalscraper',
        ...
        migrations.AddField(
            model_name='scraper',
            name='general_scraper',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dynamic_scraper.GeneralScraper'),
        ),
    ]
